...
namespace Data.Migrations
{
    ...
    [Migration("20210224091525_ModifCampagnBusinessPK")]
    partial class ModifCampagnBusinessPK
    {
            ...
            modelBuilder.Entity("Core.Models.CampaignBusiness", b =>
                {
                    ...
                    b.HasKey("BusinessTypeId", "CompagnId", "BusinessTownId");
            ...
            modelBuilder.Entity("Core.Models.Photo", b =>
                {
                    ...
                    b.Property<int?>("CampaignBusinessBusinessTownId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CampaignBusinessBusinessTypeId", "CampaignBusinessCompagnId", "CampaignBusinessBusinessTownId");
            ...
            modelBuilder.Entity("Core.Models.CampaignBusiness", b =>
                {
                    ...
                    b.OwnsOne("Core.Models.Place", "Place", b1 =>
                        {
                            b1.Property<int>("CampaignBusinessBusinessTypeId")
                                .HasColumnType("int");

                            b1.Property<int>("CampaignBusinessCompagnId")
                                .HasColumnType("int");

                            b1.Property<int>("CampaignBusinessBusinessTownId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("CampaignBusinessBusinessTypeId", "CampaignBusinessCompagnId", "CampaignBusinessBusinessTownId");

                            b1.ToTable("CompaignBusinesses");

                            b1.WithOwner()
                                .HasForeignKey("CampaignBusinessBusinessTypeId", "CampaignBusinessCompagnId", "CampaignBusinessBusinessTownId");
                        });
